...
/**
 * Ici les fonctions d'origines qu'on avait avec les sources de l'application sans vue
 * mais qu'on ne va pas pouvoir exploiter
 * ça peut faire l'objet d'un exercice supplémentaire pour le refactoriser avec les concepts Vue
 */
